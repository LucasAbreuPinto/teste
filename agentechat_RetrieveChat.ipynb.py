...
# Definindo a lista de configurações diretamente no código
config_list = [
    {
        'model': 'gpt-3.5-turbo',
        'api_key': "API KEY",
...
class RetrieveUserProxyAgentWithMessageGenerator(RetrieveUserProxyAgent):
    def message_generator(self, problem, search_string):
        # Generate a message based on the problem and search_string
        return f"Question: {problem}. Search: {search_string}"

ragproxyagent = RetrieveUserProxyAgentWithMessageGenerator(
    name="ragproxyagent",
